<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb" Inherits="promotion_login" %>
...
<head>
    ...
    <script type="text/javascript" >
                ...
                FB.login(function (response) {
                    if (response.authResponse) {
                        ...
                        FB.api('/me', function (response) {
                           ...
                           // $('#user-info').html('Bienvenido ' + 'id ' + response.id + ' name ' + response.name + '<br/>' + '<img src=\"' + 'http://graph.facebook.com/' + response.id + '/picture' + '"\ />').show('fast');
                            $('#user-info').html('Bienvenido ' + response.name + '<br/>' + '<img src=\"' + 'http://graph.facebook.com/' + response.id + '/picture' + '"\ />').show('fast');
        ...
        function (response) {
            var user = response[0];
            $('#user-info').html('Bienvenido '+ user.name  + '<img src="' + user.pic + '">'  ).show('fast');
        }
                    );
            }
            //form ------------------------------
            ...
            <div class="grid_2">
                <div class="container">
                    ...
                    <div class="containerf" id="frm-register">
                        ...
                        <br />
                        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Black" NavigateUrl="~/promotion/home.aspx">Regresar </asp:HyperLink>
